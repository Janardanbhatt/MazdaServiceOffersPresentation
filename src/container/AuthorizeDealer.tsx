                   ...
                   <div className="main">
                                   ...
                                   <div className="button" style={{paddingBottom: '20px'}}>
                                       ...
                                       <Responsive minWidth={769}>
                                           ...
                                           <a className="btn_black"
                                              ...
                                              target= "_blank" title="">
                                        <span>
                                            <p style={{paddingRight: '25px', textAlign: 'center', paddingLeft: '25px'}}>
                       ...
                       <div className="text-center" style={{minHeight: '0px', padding: '10px'}}>
                            <div className="sec2_heading flw">
                                {
                                    (currentDealerInfo.dealer_number != '00000' ? <h3>{ currentDealerInfo.dealer_name }</h3> : '')
                                }
                                {
                                ...
                                <div className="sec2_search flw">
                                    <div className="fn sec2_search_main" style={{paddingBottom: '20px'}}>
                                        <SearchDealerOnName />
                                    </div>
                                </div>
                            </div>
                       ...
                       <Responsive minWidth={769}>
                           <div className="text-center" style={{minHeight: '0px', padding: '10px'}}>
                               <div className="sec2_heading flw">
                                   {
                                       (currentDealerInfo.dealer_number != '00000' ? <h3 style={{marginTop: "40px"}}>{ currentDealerInfo.dealer_name }</h3> : '')
                                   }
                                   {
                                   ...
                                   <div className="sec2_search flw">
                                       {currentDealerInfo.dealer_number == '00000' && <div className="fn sec2_search_main" style={{marginTop: '40px', paddingBottom: '20px'}}>
                                           <SearchDealerOnName />
                                       </div> }
                                       {currentDealerInfo.dealer_number != '00000' && <div className="fn sec2_search_main" style={{marginTop: '10px', paddingBottom: '20px'}}>
                                           <SearchDealerOnName />
                                       </div> }
                                   </div>
                               </div>
